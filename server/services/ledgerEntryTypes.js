...
const TYPE_MAP = {
  ...
  'shopify_balance_transaction/fee': { type: 'Shopify fee', group: 'purchases', voided: false, sign: -1 },
  'shopify_balance_transaction/refund': { type: 'Shopify refund', group: 'invoices', voided: true, sign: -1 },
  'shopify_balance_transaction/adjustment': { type: 'Shopify adjustment', group: 'purchases', voided: false, sign: -1 },
  'shopify_payout/settled': { type: 'Shopify payout', group: 'payments', voided: false, sign: 1 },
  'paypal_payout/settled': { type: 'PayPal payout', group: 'payments', voided: false, sign: 1 },
