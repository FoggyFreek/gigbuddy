...
async function main() {
  ...
  if (!mode || args.some((a) => !['--check', '--apply', '--strict'].includes(a))) {
    throw new Error('Usage: node server/finance/vat/scripts/auditVatSchemeSnapshots.js --check|--apply [--strict]')
  }
