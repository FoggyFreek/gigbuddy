...
vi.mock('../gigs.ts', () => ({ listGigMapData: vi.fn() }))
vi.mock('../../availability/me.ts', () => ({ listMyGigMapData: vi.fn() }))
vi.mock('../../../people/venues/geocodeApi.ts', () => ({ lookupVenueGeocode: vi.fn(), lookupGeocode: vi.fn() }))
vi.mock('../../../contexts/authContext.ts', () => ({ useAuth: vi.fn() }))

import { listGigMapData } from '../gigs.ts'
import { listMyGigMapData } from '../../availability/me.ts'
import { lookupGeocode, lookupVenueGeocode } from '../../../people/venues/geocodeApi.ts'
import { useAuth } from '../../../contexts/authContext.ts'
import { useGigMapData } from '../../shared/useGigMapData.ts'
