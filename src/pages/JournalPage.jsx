...
import JournalEntryRow from '../components/journal/JournalEntryRow.jsx'
import JournalApproveErrorDialog from '../components/journal/JournalApproveErrorDialog.jsx'
import { useJournalListState } from '../components/journal/useJournalListState.js'
...
export default function JournalPage() {
  ...
  if (compact) {
    return (
      <Box>
        <Typography variant="h4" fontWeight={700} sx={{ mb: 2 }}>Journal</Typography>
