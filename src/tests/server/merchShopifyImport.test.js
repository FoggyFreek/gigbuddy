...
beforeAll(async () => {
  ...
  const importMod = await import('../../../server/commerce/merch/merchShopifyService.js')
  const shopMod = await import('../../../server/commerce/merch/shopifyService.js')
  const tokenMod = await import('../../../server/commerce/merch/shopifyTokenService.js')
  const payoutMod = await import('../../../server/commerce/merch/shopifyPayoutService.js')
  const bankMod = await import('../../../server/finance/bank-import/bankImportService.js')
