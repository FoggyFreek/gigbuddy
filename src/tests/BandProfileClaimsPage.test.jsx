...
import BandProfileClaimsPage from '../pages/admin/BandProfileClaimsPage.tsx'
import { CompactLayoutContext } from '../hooks/useCompactLayout.ts'

vi.mock('../api/admin/bandProfileClaims.ts', () => ({
...
import { listClaimQueue, listUnclaimedProfiles } from '../api/admin/bandProfileClaims.ts'
