...
import FinanceOnboardingPage from '../../../finance/onboarding/FinanceOnboardingPage.tsx'
import { getFinanceOnboardingStatus, setOpeningBalance } from '../../../finance/onboarding/financeOnboarding.ts'
import { getProfile, updateProfile, getMollieKey, getShopifySecret, getShopifyDomain, getShopifyClientId } from '../../../people/profiles/profile.ts'
import { listAccounts, getAccountingSettings } from '../../../finance/accounts/accounts.ts'

vi.mock('../../../finance/onboarding/financeOnboarding.ts', () => ({
...
vi.mock('../../../finance/accounts/accounts.ts', () => ({
  listAccounts: vi.fn(),
