...
import { unlinkProvider } from '../../../user/identity/auth.ts'
import type { AuthProvider } from '../../../user/identity/auth.ts'
import { GoogleIcon, MicrosoftIcon } from '../../../components/shared/ProviderIcons.tsx'
import TenantDeletionSection from '../../../people/workspaces/components/settings/TenantDeletionSection.tsx'
