...
import { searchSongs } from '../music/songs/songs.ts'
import { searchSetlists } from '../music/setlists/setlists.ts'
import { searchInvoices } from '../finance/invoices/invoices.ts'
import { searchPurchases } from '../finance/purchases/purchases.ts'
import { searchLedgerTransactions } from '../finance/ledger/ledger.ts'
import { searchFiles } from '../platform/files/files.ts'
