...
import { addSongLink, deleteSongLink } from '../api/songs.js'
import { songLinkShape } from '../propTypes/shared.js'

export default function SongLinks({ songId, initialLinks = [] }) {
...
SongLinks.propTypes = {
  ...
  initialLinks: PropTypes.arrayOf(songLinkShape),
}
