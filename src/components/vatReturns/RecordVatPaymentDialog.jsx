...
import { quarterLabel, outstandingCents } from '../../utils/vatReturns.js'
...
export default function RecordVatPaymentDialog({ vatReturn, onSubmit, onClose }) {
  ...
  return (
    <Dialog open onClose={onClose} fullWidth maxWidth="xs">
      <DialogTitle>
        {isRefund ? 'Record refund' : 'Record payment'} · {quarterLabel(vatReturn.year, vatReturn.quarter)}
      </DialogTitle>
      <DialogContent>
        ...
        {accounts && (
          <>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', mb: 2 }}>
              ...
              <Typography variant="h6" fontWeight={700}>{formatEur(outstanding)}</Typography>
            </Box>
            <TextField
              label="Amount (€)"
              size="small"
...
RecordVatPaymentDialog.propTypes = {
