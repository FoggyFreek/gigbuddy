...
import JournalLinePopper from './JournalLinePopper.jsx'
import { VAT_RATES } from './journalFormHelpers.js'
import { accountShape, journalLineShape } from '../../propTypes/shared.js'
...
JournalLineRow.propTypes = {
  line: journalLineShape.isRequired,
  ...
  duplicateLine: PropTypes.func.isRequired,
}
