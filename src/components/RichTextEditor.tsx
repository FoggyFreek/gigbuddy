...
// ts: @tiptap/react does not ship granular typings for the Editor class; using
// the re-exported type from the package which covers the useEditor return value.
...
// ts: Editor is typed via useEditor return type; the parameter here accepts
// whatever useEditor returns — null when not yet ready.
