...
// counts match.
export default function MoneyCells({ cents, bold = false }) {
...
MoneyCells.propTypes = {
  cents: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),
  bold: PropTypes.bool,
}
...
export function MoneyHeaderCells({ label }) {
  return <TableCell align="right" colSpan={2}>{label}</TableCell>
}

MoneyHeaderCells.propTypes = {
