...
function buildPages(sets, showPauseAndBreaks) {
  let songCounter = 0
  return (sets || []).map((set) => {
    const rows = []
...
function pageFontSize(rowCount) {
...
function PageContent({ page, showKey, showBpm, showNotes }) {
  const { set, rows } = page
  return (
    <>
...
PageContent.propTypes = {
  ...
  showBpm: PropTypes.bool.isRequired,
  showNotes: PropTypes.bool.isRequired,
}

export default function SetlistPreviewModal({ open, onClose, setlistName = '', sets = [] }) {
...
SetlistPreviewModal.propTypes = {
  open: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
  setlistName: PropTypes.string,
