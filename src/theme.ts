...
export const VARIANT_TOKENS: Record<ThemeVariant, { light: VariantTokenSet; dark: VariantTokenSet }> = {
  ...
  warm: {
    light:  { bg: '#FDF6EF', paper: '#FFF9F4', secondary: '#8B5A2B', scrollThumb: '#D4B49A', scrollThumbHover: '#B8906A', fontFamily: SYSTEM_FONT_STACK },
    dark:   { bg: '#1C1510', paper: '#2A2016', secondary: '#D4A574', scrollThumb: '#4D3820', scrollThumbHover: '#6B5030', fontFamily: SYSTEM_FONT_STACK },
  },
  slate: {
