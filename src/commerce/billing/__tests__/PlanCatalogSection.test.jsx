...
import * as api from '../../../admin/subscriptions/adminSubscriptions.ts'
import PlanCatalogSection from '../../../admin/components/PlanCatalogSection.tsx'
...
const entitlements = (features = {}, limits = {}) => ({
  features: {
    ...
    custom_slug: false, calendar_sync: false, outreach: false,
    ...features,
  },
  limits: {
