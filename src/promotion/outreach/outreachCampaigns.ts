...
export interface OutreachCampaign { id: Id; status: string; template_id: Id | null; created_at: string; sent_at: string | null; subject_snapshot?: string; recipients?: OutreachRecipient[] }
