...
import MembersSection from '../../people/workspaces/components/settings/MembersSection.tsx'

vi.mock('../../people/memberships/users.ts', () => ({
...
import {
  ...
  removeMembership,
} from '../../people/memberships/users.ts'
