...
vi.mock('../../planning/gigs/gigs.ts', () => ({ searchGigs: vi.fn().mockResolvedValue([]) }))
vi.mock('../../people/contacts/contacts.ts', () => ({ searchContacts: vi.fn().mockResolvedValue([]) }))
vi.mock('../../music/songs/songs.ts', () => ({ searchSongs: vi.fn().mockResolvedValue([]) }))
vi.mock('../../music/setlists/setlists.ts', () => ({ searchSetlists: vi.fn().mockResolvedValue([]) }))
vi.mock('../../finance/invoices/invoices.ts', () => ({ searchInvoices: vi.fn().mockResolvedValue([]) }))
vi.mock('../../finance/purchases/purchases.ts', () => ({ searchPurchases: vi.fn().mockResolvedValue([]) }))
vi.mock('../../finance/ledger/ledger.ts', () => ({ searchLedgerTransactions: vi.fn().mockResolvedValue([]) }))
vi.mock('../../platform/files/files.ts', () => ({ searchFiles: vi.fn().mockResolvedValue([]) }))
vi.mock('../../people/venues/venues.ts', () => ({ searchVenues: vi.fn().mockResolvedValue([]) }))
vi.mock('../../planning/tasks/tasks.ts', () => ({ searchTasks: vi.fn().mockResolvedValue([]) }))
...
import { searchGigs } from '../../planning/gigs/gigs.ts'
import { searchContacts } from '../../people/contacts/contacts.ts'
import { searchVenues } from '../../people/venues/venues.ts'
import { searchTasks } from '../../planning/tasks/tasks.ts'
