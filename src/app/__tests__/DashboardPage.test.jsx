...
vi.mock('../../planning/rehearsals/rehearsals.ts', () => ({ getNextRehearsal: vi.fn() }))
vi.mock('../../planning/events/bandEvents.ts', () => ({ listUpcomingBandEvents: vi.fn() }))
...
vi.mock('../../user/achievements/achievements.ts', () => ({ listAchievements: vi.fn() }))
...
import { listGigs, listUpcomingGigs, getGig, searchGigs } from '../../planning/gigs/gigs.ts'
...
import { getProfile, updateProfile } from '../../people/profiles/profile.ts'
