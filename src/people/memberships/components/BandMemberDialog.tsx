...
import type { BandMemberRole } from '../bandMemberRoles.ts'
import MemberRolesControl from './MemberRolesControl.tsx'
      ...
      <DialogContent>
        <Stack spacing={2} sx={{ pt: 1 }}>
          ...
          <TextField
            ...
            fullWidth
          />
          <MemberRolesControl roles={roles} mode="edit" onChange={setRoles} />
          <TextField
            select
