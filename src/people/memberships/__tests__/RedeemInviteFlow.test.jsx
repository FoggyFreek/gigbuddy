...
import RedeemInvitePage from '../RedeemInvitePage.tsx'
import OnboardingPage from '../../../user/identity/OnboardingPage.tsx'

vi.mock('../../../user/identity/auth.ts', () => ({
...
vi.mock('../../../commerce/billing/billing.ts', () => ({
  getBillingState: vi.fn(),
  subscribe: vi.fn(),
  syncSubscription: vi.fn(),
}))

import { getCurrentUser, logout as apiLogout } from '../../../user/identity/auth.ts'
